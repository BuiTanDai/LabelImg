...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, defaultFilename=None, defaultPrefdefClassFile=None, defaultSaveDir=None):
        ...
        predict = action('&Predict', self.predict,
                                'Ctrl+Shift+P', 'predict', u'Predict Images')
    ...
    def predict(self, _value=False):
        lf = LabelFile()
        shapes = [{'label': 'test1', 'points': [(126.0, 24.0), (252.0, 24.0), (252.0, 189.0), (126.0, 189.0)],
                   'difficult': False, 'line_color': (10, 194, 205, 100), 'fill_color': (10, 194, 205, 100)},
                  {'label': 'tv',
                   'points': [(298.1525423728813, 30.474576271186436), (299.13559322033893, 30.474576271186436),
                              (299.13559322033893, 3.552713678800501e-15), (298.1525423728813, 3.552713678800501e-15)],
                   'difficult': False, 'line_color': (104, 128, 231, 100), 'fill_color': (104, 128, 231, 100)}]
        bigshapes =[[r'C:\Users\intern.btdai\Desktop\testing\5', shapes],[r'C:\Users\intern.btdai\Desktop\testing\11', shapes]]
        # bigshapes[0] = {r'C:\Users\intern.btdai\Desktop\testing\5', shapes}
        # bigshapes[1] = {r'C:\Users\intern.btdai\Desktop\testing\6', shapes}
        for i in bigshapes:
            lf.savePascalVocFormat(i[0] +'.xml' , i[1], i[0] +'.png' , '')
        self.statusBar().showMessage("Predict completely!")
